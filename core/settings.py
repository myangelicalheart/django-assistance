...
CSRF_TRUSTED_ORIGINS = ['http://0.0.0.0','http://127.0.0.1','https://django-assistance-production.up.railway.app','https://' + env('SERVER', default='127.0.0.1') ]
...
MEDIA_URL = '/apps/static/assets/logos/'
